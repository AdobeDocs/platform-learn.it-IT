...
Altri modi comuni per inviare dati in streaming a Platform
...
* Dobbiamo implementare Web SDK sul sito web Luma per inviare i dati sull’attività dei visitatori dal sito web alla rete Experience Platform Edge. Verrà eseguita una semplice implementazione utilizzando i tag (precedentemente Launch)
