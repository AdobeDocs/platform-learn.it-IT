---
title: Conclusione e passaggi successivi dell’esercitazione su Web SDK
description: Come procedere dopo aver completato l'esercitazione di Web SDK
...
* Campi acquisiti da un livello di dati, trasformati in XDM e inviati ad Edge Network della piattaforma.
* Consenso acquisito e identità autenticate.
* L’implementazione di Web SDK è stata connessa alle seguenti applicazioni Experience Cloud:
   * Adobe Experience Platform
   * Adobe Analytics
   * Adobe Audience Manager
   * Adobe Target
   * Adobe Journey Optimizer
* Inoltrato dati da Platform Edge Network a un hook web con inoltro di eventi.
...
* **Implementare Platform Mobile SDK**. Ora che hai acquisito dimestichezza con un SDK, imparane un altro. Il SDK Adobe Experience Platform Mobile viene utilizzato per alimentare Experience Cloud e i servizi di terze parti sulle app mobili. Esiste un&#39;esercitazione pratica [simile per Mobile SDK](https://experienceleague.adobe.com/it/docs/platform-learn/implement-mobile-sdk/overview). Completa entrambe le operazioni e vedi l’unione dei profili tra i dispositivi.
