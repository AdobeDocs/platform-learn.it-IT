...
In questo esercizio creerai uno schema XDM utilizzando i gruppi di campi della linea di base consigliati per l’acquisizione dei dati dell’evento web sul [sito web di dimostrazione Luma](https://luma.enablementadobe.com){target="_blank"}:
