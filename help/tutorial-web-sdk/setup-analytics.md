...
Qui sopra hai configurato una sostituzione dello stream di dati per la [home page Luma](https://luma.enablementadobe.com).  Per convalidare questa configurazione
...
Vai a una pagina di prodotto come la [pagina di prodotto di Livingston All-Purpose Tight](https://luma.enablementadobe.com/product.html?id=LLMP09).  Verifica che le visualizzazioni della pagina di contenuto siano acquisite da Analytics.
...
1. Aggiungi [Marco Lightweight Active Hoodie](https://luma.enablementadobe.com/product.html?id=LLMH13) al carrello
1. Vai alla [pagina carrello](https://luma.enablementadobe.com/cart.html), controlla Edge Trace per
