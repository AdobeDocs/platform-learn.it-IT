...
1. Come **[!UICONTROL Nome]**, immetti `Luma Web SDK Tutorial` (aggiungi il tuo nome alla fine, se più persone della tua azienda stanno seguendo questa esercitazione)
...
1. Configura l&#39;**[!UICONTROL ambiente di produzione]**. (Gli altri ambienti di tag nella proprietà ereditano le impostazioni di produzione):
   ...
   1. Seleziona lo stream di dati creato in precedenza, `Luma Web SDK: Development Environment`
1. Seleziona **[!UICONTROL Salva]**
