...
1. Apri la [home page Luma](https://luma.enablementadobe.com) (mappata alla tua proprietà tag) e la **Adobe Experience Platform Debugger** e aggiorna la pagina.
...
1. Apri la home page del sito web di dimostrazione [Luma](https://luma.enablementadobe.com) con mappatura sulla proprietà tag per qualificarti per il segmento appena creato.
