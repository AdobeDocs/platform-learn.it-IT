...
In Xcode nell’origine per **[!UICONTROL AppDelegate]** e **[!UICONTROL MobileSDK]**, aggiungi le seguenti importazioni.
...
1. Aggiungi il seguente codice evidenziato al `application(_, didFinishLaunchingWithOptions)` funzione.
