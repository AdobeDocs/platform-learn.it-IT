...
Per questo esercizio eseguirai una configurazione non elaborata del Web SDK di Adobe e richiederai la migliore offerta successiva all’Offer decisioning di Adobe Journey Optimizer.
...
La libreria **alloy.js** è la libreria in esecuzione di Web SDK che consente di inviare richieste da un sito Web all&#39;Edge Network di Adobe e da lì applicazioni come Adobe Experience Platform, Adobe Analytics, Adobe Target e altro ancora.
...
Questo blocco di codice viene utilizzato per recuperare il valore dell’ID Experience Cloud (ECID). L’ECID è l’identificatore univoco del dispositivo del browser.
...
Nella richiesta, sono specificati 2 **Ambiti decisionali** che chiederanno all&#39;Offer decisioning di Adobe Journey Optimizer di fornire una decisione sull&#39;offerta che deve essere vista da questo ECID.
