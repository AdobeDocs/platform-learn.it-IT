...
Prima di eseguire questa esercitazione, è necessario installare le seguenti applicazioni nel computer:

- Adobe Creative Cloud
- Photoshop 2025
- Postman

## 1. Installa l’estensione Chrome per la documentazione di Experience League

### Informazioni sull’estensione Chrome

La documentazione è stata resa generica in modo da poter essere riutilizzata facilmente da chiunque, utilizzando qualsiasi istanza di Adobe.
...
| Nome | Chiave |
|:-------------:| :---------------:|
| ID organizzazione IMS | `--aepImsOrgId--` |
