...
>[!IMPORTANT]
>
>Se non sei un dipendente Adobe, segui le istruzioni per [installare Postman](./ex3.md){target="_blank"}. Le istruzioni seguenti sono destinate esclusivamente ai dipendenti di Adobe.
...
Vai a [Applicazioni da installare](./ex5.md){target="_blank"}
