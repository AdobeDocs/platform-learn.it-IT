...
Vai a [https://dsn.adobe.com/install](https://dsn.adobe.com/install){target="_blank"} sul tuo computer e passa a **Beta versione**. Accedi con il tuo Adobe ID per visualizzarlo.

![DSN](./images/mobileapp.png)

Utilizza l&#39;app **Fotocamera** sul tuo smartphone per installare l&#39;app mobile per il sistema operativo del tuo dispositivo. Per questa abilitazione, è necessario installare la versione **0.6.1** (o successiva) che utilizza il SDK di Adobe Experience Platform Mobile.
...
Dopo aver analizzato il codice QR, seleziona **Installa**.
...
Vedrai quindi il tuo ID progetto caricato nell&#39;app, dopodiché potrai fare clic su **Switch**.

![DSN](./images/mobileappn7.png)

Dovresti quindi vedere il brand demo **CitiSignal** caricato. L&#39;app è ora pronta per essere utilizzata.
