...
# 3.3.3 Prepara la proprietà del client di raccolta dati di Adobe Experience Platform e la configurazione del SDK web per Offer Decisioning
...
In questo esercizio, devi configurare **Datastream** affinché funzioni con **Offer Decisioning**.
...
Ogni volta che carichi una **pagina generale**, come ad esempio la home page del sito Web demo, Offer Decisioning valuterà l&#39;offerta applicabile e restituirà una risposta al sito Web con i dettagli dell&#39;offerta da mostrare. La visualizzazione dell’offerta sul sito web richiede una configurazione aggiuntiva, che verrà eseguita nel passaggio successivo.
...
Nella tua proprietà, passa a **Regole**. Cerca e apri la regola **Offerta di visualizzazione (Offer Decisioning)**.
...
La riga 17 applica l’immagine restituita da Offer Decisioning al sito web. Fai clic su **[!UICONTROL Salva]**.
...
- 1 Implementazione di Offer Decisioning utilizzando la proprietà Data Collection
...
Vai a [3.3.4 Combina Adobe Target e Offer Decisioning](./ex4.md){target="_blank"}
