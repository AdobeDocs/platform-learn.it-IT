...
# 1.3.1 Configurare l’ambiente Snowflake
...
Fare clic su **+ Crea** e quindi selezionare **Foglio di lavoro SQL**.
...
Ci vorrà un paio di minuti, dopo di che vedrete questo.
...
Vai a [1.3.2 Creare schemi, modelli di dati e collegamenti](./ex2.md){target="_blank"}
