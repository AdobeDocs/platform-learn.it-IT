...
## 1.1.6.1 Aggiungi il plug-in all’archivio
...
## 1.1.6.5 Inviare dati a Adobe Experience Platform Edge Network
...
## 1.1.6.6 Visualizzare il profilo del cliente in Adobe Experience Platform
