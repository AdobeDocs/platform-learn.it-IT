...
# 1.1.5 Blocco personalizzato avanzato
...
## 1.1.5.2 Aggiungere logica e caricare dati da un endpoint esterno
...
Passaggio successivo: [1.1.6 Plug-in AEM Edge Delivery Services MarTech](./ex6.md){target="_blank"}
