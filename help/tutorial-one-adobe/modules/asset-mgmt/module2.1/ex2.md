...
# 1.1.2 Creare un sito web basato su documenti
...
## 1.1.2.1 Configurare l&#39;unità Google
...
## 1.1.2.2 Configurare l’archivio GitHub
...
## 1.1.2.3 Aggiornare il file fstab.yaml
...
## 1.1.2.4 Installare l’estensione AEM Sidekick
...
## 1.1.2.5 Anteprima e pubblicazione del sito web basato su documenti

Tornare alla cartella dell&#39;unità Google. Nella barra delle applicazioni fare clic sull&#39;estensione **AEM Sidekick**. Viene quindi visualizzato un pop-up con la barra di AEM Sidekick nella cartella.
...
Selezionare di nuovo i 3 file nella cartella Google Drive. Fare clic su **Pubblica**.
...
- **.live** fa riferimento all&#39;ambiente live della tua istanza di AEM
...
## 1.1.2.6 Apportare una modifica e pubblicarla
...
Viene quindi aperta la versione di anteprima del sito Web. Rivedi le modifiche e fai clic su **Pubblica**.
