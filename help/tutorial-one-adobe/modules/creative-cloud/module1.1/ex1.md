...
![Adobe I/O di nuova integrazione](./images/iopm.png){zoomable="yes"}

1. Seleziona il nome del progetto.

![Adobe I/O di nuova integrazione](./images/api13.png){zoomable="yes"}

1. Seleziona **Modifica progetto**.

![Adobe I/O di nuova integrazione](./images/api14.png){zoomable="yes"}

1. Immetti un nome descrittivo per l&#39;integrazione: `--aepUserLdap-- Firefly`e seleziona **Salva**.

![Adobe I/O di nuova integrazione](./images/api15.png){zoomable="yes"}

La configurazione dell’integrazione Adobe I/O è terminata.

![Adobe I/O di nuova integrazione](./images/api16.png){zoomable="yes"}

## 1.1.1.3 Autenticazione Postman per Adobe I/O
...
![Adobe I/O di nuova integrazione](./images/getstarted.png){zoomable="yes"}
...
![Adobe I/O di nuova integrazione](./images/pmfolder.png){zoomable="yes"}
...
![Adobe I/O di nuova integrazione](./images/pmfolder1.png){zoomable="yes"}

1. In Postman, selezionare **Importa**.

![Adobe I/O di nuova integrazione](./images/postmanui.png){zoomable="yes"}

1. Selezionare **File**.

![Adobe I/O di nuova integrazione](./images/choosefiles.png){zoomable="yes"}

1. Scegli i tre file dalla cartella, quindi seleziona **Apri** e **Importa**.

![Adobe I/O di nuova integrazione](./images/selectfiles.png){zoomable="yes"}

![Adobe I/O di nuova integrazione](./images/impconfirm.png){zoomable="yes"}
...
## API di servizi di Firefly 1.1.1.5, testo 2 immagine
