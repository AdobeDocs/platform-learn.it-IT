...
![Modelli personalizzati per Firefly](./images/ffcm1.png){zoomable="yes"}

È possibile che questo messaggio venga visualizzato. In caso contrario, fare clic su **Accetto** per continuare.

![Modelli personalizzati per Firefly](./images/ffcm2.png){zoomable="yes"}

Dovresti vedere questo. Fai clic su **Addestra un modello**.

![Modelli personalizzati per Firefly](./images/ffcm3.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm4.png){zoomable="yes"}

Assegnare un nome al nuovo progetto: `--aepUserLdap-- - Custom Models`. Fai clic su **Crea**.

![Modelli personalizzati per Firefly](./images/ffcm5.png){zoomable="yes"}

Dovresti vedere questo. Fai clic su **Crea**.

![Modelli personalizzati per Firefly](./images/ffcm6.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm7.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm8.png){zoomable="yes"}

Passare alla cartella contenente i file dell&#39;immagine di download. Selezionali tutti e fai clic su **Apri**.

![Modelli personalizzati per Firefly](./images/ffcm9.png){zoomable="yes"}

Si vedrà che le immagini vengono caricate.

![Modelli personalizzati per Firefly](./images/ffcm10.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm11.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm12.png){zoomable="yes"}

Poi vedrai questo. La formazione del modello può richiedere dai 20 ai 30 minuti o più.

![Modelli personalizzati per Firefly](./images/ffcm13.png){zoomable="yes"}

Dopo 20-30 minuti, il modello è ora addestrato e può essere pubblicato. Fare clic su **Publish**.

![Modelli personalizzati per Firefly](./images/ffcm14.png){zoomable="yes"}

Fai di nuovo clic su **Publish**.

![Modelli personalizzati per Firefly](./images/ffcm15.png){zoomable="yes"}

Chiudere la finestra a comparsa **Condividi modello personalizzato**.

![Modelli personalizzati per Firefly](./images/ffcm16.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm19.png){zoomable="yes"}

Fare clic su **Anteprima e prova**.

![Modelli personalizzati per Firefly](./images/ffcm17.png){zoomable="yes"}

Viene quindi visualizzato il prompt di esempio immesso prima dell&#39;esecuzione.

![Modelli personalizzati per Firefly](./images/ffcm18.png){zoomable="yes"}

## 1.1.4.3 Abilita il modello personalizzato per l’API dei modelli personalizzati di Servizi di Firefly

Una volta che il modello personalizzato è stato addestrato, può essere utilizzato anche tramite l’API. Nell’esercizio 1.1.1 hai già configurato il progetto Adobe I/O per l’interazione con Servizi di Firefly tramite l’API.
...
![Modelli personalizzati per Firefly](./images/ffcm20.png){zoomable="yes"}

Per accedere a un modello personalizzato di Firefly, il modello personalizzato deve essere condiviso con l&#39;**ID account tecnico** del nostro progetto di Adobe I/O.
...
![Modelli personalizzati per Firefly](./images/ffcm24.png){zoomable="yes"}

Fare clic su **Server-to-Server OAuth**.

![Modelli personalizzati per Firefly](./images/ffcm25.png){zoomable="yes"}

Fai clic per copiare il tuo **ID account tecnico**.

![Modelli personalizzati per Firefly](./images/ffcm23.png){zoomable="yes"}

Incolla il tuo **ID account tecnico** e fai clic su **Invita a modificare**.

![Modelli personalizzati per Firefly](./images/ffcm21.png){zoomable="yes"}

L&#39;**ID account tecnico** deve ora essere in grado di accedere al modello personalizzato.

![Modelli personalizzati per Firefly](./images/ffcm22.png){zoomable="yes"}

## 1.1.4.4 Interagire con i modelli API personalizzati di Servizi di Firefly

>[!IMPORTANT]
>
>Se sei un dipendente Adobe, segui le istruzioni qui riportate per utilizzare [PostBuster](./../../../postbuster.md).

Nell&#39;esercizio 1.1.1 Guida introduttiva a Servizi di Firefly, hai scaricato il file [postman-ff.zip](./../../../assets/postman/postman-ff.zip) sul desktop locale e quindi hai importato la raccolta in Postman.

Apri Postman e vai alla cartella **FF - Modelli personalizzati API**.

![Modelli personalizzati per Firefly](./images/ffcm30.png){zoomable="yes"}

Apri la richiesta **1. FF - getCustomModels** e fare clic su **Invia**.

![Modelli personalizzati per Firefly](./images/ffcm31.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm32.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm33.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm34.png){zoomable="yes"}

Apri la richiesta **3. Ottieni lo stato CM** e fai clic su **Invia**. A questo punto lo stato è impostato su In esecuzione.

![Modelli personalizzati per Firefly](./images/ffcm35.png){zoomable="yes"}
...
![Modelli personalizzati per Firefly](./images/ffcm36.png){zoomable="yes"}

Questa è la prima immagine generata in questo esempio.

![Modelli personalizzati per Firefly](./images/ffcm37.png){zoomable="yes"}

Questa è la seconda immagine generata in questo esempio.

![Modelli personalizzati per Firefly](./images/ffcm38.png){zoomable="yes"}
