...
Selecione seu evento, arraste e solte o evento na tela de jornada. Sua jornada agora deve ser semelhante ao seguinte. Cricca em **Ok** para salvar suas alterações.

![ACOP](./images/journeyevent.png)

Como segunda etapa da jornada, você deve adicionar uma ação **Spingi**. Vá para o lado esquerdo da tela para **Azioni**, selecione a ação **Push** e arraste e solte a ação no segundo nó da sua jornada.

![ACOP](./images/journeyactions.png)

Non c&#39;è nessun lado direito da tela, agora você deve criar sua notificação push.

Definisci una **Categoria** como **Marketing** e selecione um push surface que permite enviar notificações push. Nesse caso, un superfície spinge un ser selecionada é **mmeeewis-app-mobile-bootcamp**.
...
Agora você trazer o token de personalização para o campo **Nome** que está armazenado em `profile.person.name.firstName`. Nessun menu à esquerda, selecione **Attributi profilo**, ruolo para baixo/navegue para encontrar o elemento **Persona** e clique na seta para avançar um nível até chegar ao campo `profile.person.name.firstName`. Cricca no ícone **+** para adicionar o campo à tela. **Salva**.
...
Clique em **Inserisci contesto**.

![ACOP](./images/jomsg6.png)

Interazione tra i punti di interesse **POI**.

![ACOP](./images/jomsg7.png)

Dettagli Clique em **POI**.

![ACOP](./images/jomsg8.png)

Cricca senza icona **+** su **Nome POI**.
Em seguida, o seguinte será exibido. **Salva**.
...
**sendMessageToScreen** é uma ação personalizada que irá publicar uma mensagem no **Endpoint** usado pela exibição na loja. Un ação **sendMessageToScreen** espera que múltiplas variáveis sejam definidas. Você pode visualizar essas variáveis rolando para baixo até ver **Parametri azione**.
...
Em seguida, selezione **Modalità avanzata**.

![ACOP](./images/jomsg18.png)

Em seguida, cole o valor com base na tabela acima. Coppia em **Ok**.
...
Você pode inserir o nome da jornada aqui Usa `yourLastName - Beacon Entry Journey`. Cricca em **OK** para salvar suas alterações.
...
Eta di Próxima: [3.4 Teste sua jornada](./ex4.md)
