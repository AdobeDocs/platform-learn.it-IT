...
# 5.1.3 Query, query, query... e analisi dell’abbandono
...
## 5.1.3.1 Scrivere query di base per l’analisi dei dati
...
Passaggio successivo: [5.1.4 Genera un set di dati da una query](./ex4.md)
