...
* Conosci il tuo ID tenant di Experience Platform. Puoi ottenerla effettuando una [richiesta API](https://experienceleague.adobe.com/docs/experience-platform/xdm/api/getting-started.html?lang=it#know-your-tenant_id) autenticata
