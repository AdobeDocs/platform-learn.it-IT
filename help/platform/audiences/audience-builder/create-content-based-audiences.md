...
description: Scopri le nozioni di base sulla creazione di un pubblico di affinità per i contenuti nel generatore di regole per il pubblico in Experience Platform.
feature: Segments
role: User
level: Intermediate
jira: KT-7889
...
Scopri le nozioni di base sulla creazione di un pubblico di affinità per i contenuti nel generatore di regole per il pubblico in Experience Platform. Per ulteriori informazioni, consulta la [documentazione di Segment Builder](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/segment-builder.html?lang=it).
