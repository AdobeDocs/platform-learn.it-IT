...
Scopri le nozioni di base sulla creazione di un pubblico di affinità per i contenuti nel generatore di regole per i tipi di pubblico in Experience Platform. Per ulteriori informazioni, consulta la [documentazione di Segment Builder](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/segment-builder.html?lang=it).
